...
<div class="defaultcontainer">
    ...
    <div class="helpcontainer">
                ...
                <div class="helpinfos">
                    ...
                    <!-- how to use it -->
                    <div class="shipping">
                            <p class="links"><a href="/faqs">FAQs</a></p> 
                            <p class="links"><a href="/generator">HOW TO USE GENERATOR</a></p>   
                            <p class="links"><a href="/terms">TERMS & CONDITIONS</a></p> 
                                          

                            <h2 class="title2" style="color:var(--nude);">shipping costs</h2>
                            ...
                            <p>*SINTA offers free standard delivery on orders shipped to the Philippines.</p>


                            <!-- Delivery -->
                            <br><br>
                            <h2 class="title2" style="color:var(--nude);">delivery</h2>

                            <table class="shippingtable">
                                <tr>
                                    <td>DHL Freight (EU)</td>
                                    <td>9-12 business days for creating the item and delivering</td>
                                </tr>
                                <tr>
                                    <td>DHL Express Economy (EU)</td>
                                    <td>Creating|Delivery in Europe within 7-10 business days</td>
                                </tr>
                                <tr>
                                    <td>DHL Express Worldwide (Non - EU)</td>
                                    <td>Worldwide Delivery 7-12 business days</td>
                                </tr>
                            </table>
                            <br><br>
                            ...
                            <br><br>
                            <span class="highlightnude">contact@sinta.ph</span><br><br>
