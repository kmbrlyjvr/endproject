...
<!--<a href="{{ URL::previous() }}" class="back_button">Back</a> -->
    ...
    <br>
       <section class="blogimagessmall">
            ...
            <div class="blogimagethree"><img class="outer" src="{{ asset('storage/' . $blog->imagethree)}}" alt="girl and sneakers"></div>
            <div class="blogimagefour"><img class="outer" src="{{ asset('storage/' . $blog->imagefour)}}" alt="girl and sneakers"></div><br>
       </section>   
       <br>
       <br> 
